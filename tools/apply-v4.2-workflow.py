...
'''        self.bigseller_var = tk.StringVar(); self.bigseller_auto_var = tk.BooleanVar()\n        self.entry_row(big, "Page URL", self.bigseller_var)\n        self.label(big, "Choose BigSeller in Scan output target for production. Use Notepad Test while validating scans.", 8, False, MUTED).pack(anchor="w", padx=14, pady=(4,6), wraplength=285, justify="left")\n        self.button(big, "Open BigSeller", self.open_bigseller).pack(fill="x", padx=14, pady=(4,6))''',
...
# Make status wording generic for Notepad/BigSeller.
