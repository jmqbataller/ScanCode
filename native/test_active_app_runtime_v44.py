...
import scancode_app_v44 as appmod
...
def main():
    ...
    copied = []
    sent = []
    old_copy = appmod.base.pyperclip.copy
    old_send = appmod.base.send_keys

    try:
        appmod.base.pyperclip.copy = lambda value: copied.append(value)
        appmod.base.send_keys = lambda keys, pause=.0: sent.append((keys, pause))
        ...
        appmod.base.pyperclip.copy = old_copy
        appmod.base.send_keys = old_send
